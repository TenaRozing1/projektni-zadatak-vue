<template>
    <!-- <div class="relative bg-projectColors-lighter-blue">
        ...
        <div class="absolute flex justify-between mr-130p mt-136p" style="top:0; right: 0;">
            ...
            <img src="../images/watch.png" class="ml-51p">
        </div>
        <div class="absolute" style="bottom:0; right: 0; left: 0;">
            <div class="flex ml-213p mr-113p pb-201p">
                <img src="../images/laptop.png" class="mr-133p">
                <div>
